...
// Define the type for benefits and prerequisites
interface Item {
  title: string;
}
...
const CourseData: FC<Props> = ({
  ...
  return (
    <div className="w-[80%] m-auto mt-32 block">
      <div>
        <label className={`${styles.label} text-[20px]`} htmlFor="benefits">
          What are the benefits for students in this course?
        </label>
        <br />
        {benefits.map((benefit: Item, index: number) => (
          <input
            type="text"
            key={index}
            name="Benefit"
      ...
      <div>
        ...
        <br />
        {prerequisites.map((prerequisite: Item, index: number) => (
          <input
            type="text"
            key={index}
            name="prerequisites"
