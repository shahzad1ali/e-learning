...
const CoursePreview: FC<Props> = ({ courseData, handleCourseCreate, setActive, active, isEdit }) => {
  ...
  return (
    <div className='w-[90%] m-auto py-5 mb-4'>
      <div className="w-full relative">
        ...
        <div className="flex items-center">
          ...
          <h5 className="pl-4 text-[20px] mt-2 line-through opacity-80">
      ...
      <div className="w-full">
        <div className="w-full 800px:pr-5">
          <h1 className="text-[25px] font-Poppins font-[600]">
            {courseData?.name} IPhone14Promax 8GB RAM 256Memory like this mobiles
          </h1>
          ...
          <br />
          <h1 className="text-[25px] font-Poppins font-[600]">
            IPhone14Promax 8GB RAM 256Memory like this mobiles
          </h1>
        </div>
        ...
        {courseData?.benefits?.map((item, index) => (
          <div className="w-full flex 800px:items-center py-2" key={index}>
            ...
            <p className="pl-2">{item.title} yes this is </p>
          </div>
        ))}
        ...
        {courseData?.prerequisites?.map((item, index) => (
          <div className="w-full flex 800px:items-center py-2" key={index}>
            ...
            <p className="pl-2">{item.title} dui2nwk</p>
          </div>
        ))}
        ...
        <div className="w-full">
          ...
          <p className="text-[18px] mt-[20px] whitespace-pre-line w-full overflow-hidden">
            {courseData?.description} you will also dynamic
          </p>
        </div>
...
//   const discountPersentenge = ((courseData.estimatedPrice - courseData.price) / courseData.estimatedPrice) * 100;
//   const discountPersentangePrice = discountPersentenge.toFixed(0);
