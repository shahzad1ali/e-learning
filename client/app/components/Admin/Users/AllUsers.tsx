...
const AllUsers: FC<Props> = ({ isTeam }) => {
      ...
      renderCell: (params: any) => {
        return (
          <>
            ...
            >
              <AiOutlineDelete
                className={`dark:text-white text-black  ${isDark ? "bg-dark text-white" : "bg-white text-black"}`}
                size={20}
              />
            </Button>
          </>
        ...
        return (
          <>
            <a href={`mailto:${params.row.email}`}>
              <AiOutlineMail className={`dark:text-white text-black mt-4 ${isDark ? "bg-dark text-white" : "bg-white text-black"}`} size={20} />
            </a>
          </>
        );
      },
  ...
  return (
    <div className={`mt-1 ${isDark ? "bg-dark text-white" : "bg-white text-black"}`}>
      {isLoading ? (
        <Loader />
      ) : (
        <Box m="20px">
