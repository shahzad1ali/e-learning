...
import { addAnwser, addQuestion, addReplyToReview, addReview, deleteCourse, editCourse, generateVedioUrl, getAdminAllCources, getAllCourses, getCourseByUser, getSingleCourse, uploadCourse } from "../controllers/course.controller";
...
courseRouter.get('/get-admin-courses', isAuthenticated, authorizeRoles("admin"), getAdminAllCources);
